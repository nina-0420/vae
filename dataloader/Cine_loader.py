...
# =============================================================================
        ...
        for idx, ID in enumerate(ids_set.values):
            ...
            imgs_per_id = glob.glob(dir_imgs + 'ukbb_cine_sax/' + str(int(ID[0])) + '/' + 'image_SAX_001.vtk')
            ...
            if len(img_21015) >= 1:
                ...
                # paths for cmr
                self.path_imgs_sax.append(dir_imgs + 'ukbb_cine_sax/' + str(int(ID[0])) + '/' + 'image_SAX_001.vtk')
                # Coordinates
...
# =============================================================================
    ...
    def __len__(self):
        return len(self.path_imgs_sax) # self.num_parti
...
# =============================================================================
        ...
        # Loading sax
        cine, output_image_np_mean, output_image_np_std, output_image_np_max = self.pad_input.get(self.path_imgs_sax[index],
        ...
        return cine, self.img_names[index],output_image_np_mean,output_image_np_std, output_image_np_max # index  # torch.FloatTensor(self.mtdt[index])
        #return sax, torch.FloatTensor(self.mtdt[index]), self.img_names[index] # index  # torch.FloatTensor(self.mtdt[index])


def Cine_loader(batch_size,
              #tagging_img_size,
              sax_img_size,
              num_workers,
              shuffle,
    ...
    print('Found ' + str(len(TC_dataset)) + ' cine images')
