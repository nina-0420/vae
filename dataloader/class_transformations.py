...
class TransformationGeneratort(object):
    ...
    def load_input(self, path_img, crop_c_min_tagging, crop_c_max_tagging, crop_r_min_tagging, crop_r_max_tagging, roi_length):
    #def load_input(self, path_img, crop_c_min, crop_c_max, crop_r_min, crop_r_max, roi_length):
        ...
        image = self.load_and_preprocess(crop_c_min_tagging, crop_c_max_tagging, crop_r_min_tagging, crop_r_max_tagging, roi_length)
    ...
    def cropper(self, image_load, crop_c_min_tagging, crop_c_max_tagging, crop_r_min_tagging, crop_r_max_tagging, roi_length):
        ...
        original_r_min = max(0, crop_r_min_tagging)
        original_r_max = min(image_data.shape[0] - 1, crop_r_max_tagging)
        original_c_min = max(0, crop_c_min_tagging)
        original_c_max = min(image_data.shape[1] - 1, crop_c_max_tagging)
    ...
    def load_and_preprocess(self, crop_c_min_tagging, crop_c_max_tagging, crop_r_min_tagging, crop_r_max_tagging, roi_length):
        """
        ...
        cropped_image_np = self.cropper(np_array, crop_c_min_tagging, crop_c_max_tagging, crop_r_min_tagging, crop_r_max_tagging, roi_length)
        #cropped_image_np = np_array#nina
    ...
    def get(self, path_img, crop_c_min_tagging, crop_c_max_tagging, crop_r_min_tagging, crop_r_max_tagging, roi_length):
        """
...
# =============================================================================
            ...
            output_image_np = self.load_input(path_img, crop_c_min_tagging, crop_c_max_tagging, crop_r_min_tagging, crop_r_max_tagging, roi_length)
